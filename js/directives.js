...
{
var Current =  '<div id="wrapper"><div id="scroller_current" class="scroller" ><ul><li ng-repeat="teacher in data"><div class="image"><img resize-current class="current_image" src="{{teacher.image}}?w={{windowWidth}}" alt="{{teacher.firstname}} {{teacher.lastname_forDOM}}"/></div><div class="teacher_info"><h6><a href="#/2014/{{teacher.firstname}}*{{teacher.lastname}}">NOAA Teacher at Sea {{teacher.firstname}} {{teacher.lastname_forDOM}} of {{teacher.city}}, {{teacher.state}} {{teacher.verb}} aboard {{teacher.shiptype}} <em>{{teacher.ship}}</em>.</a></h6></div></li></ul></div></div><div><a class="navPrev3 no" ng-click="prev(\'current\');">««</a><a ng-click="next(\'current\')" class="navNext3 no" >»»</a></div><script>myScroll  = new iScroll("wrapper", {hScrollbar:false});</script>';
	var  Alumni = '<div id="wrapper_alumni"><div id="scroller_alumni" class="scroller" style="transition: transform 0ms; -webkit-transition: transform 0ms; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) translateZ(0px);"><ul><li ng-repeat = "spot in data"><div class="image"><img resize-home class="current_image" src="{{spot.url}}?w={{windowWidth}}"" alt="{{spot.caption}}"></div><div class="teacher_info"><h6><a href="#{{spot.hash}}">{{spot.firstname}} {{spot.lastname}}</a></h6></div></li></ul></div></div><div><a class="navPrev3" ng-click="prev(\'alumni\');">««</a><a ng-click="next(\'alumni\')" class="navNext3" >»»</a></div><script>myScroll_spotlights  = new iScroll("wrapper_alumni", {hScrollbar:false});</script>';
	var Pow = '<div id="wrapper_pow"><div id="scroller_pow" class="scroller" style="transition: transform 0ms; -webkit-transition: transform 0ms; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) translateZ(0px);"><ul ><li ng-repeat = "pow in data"><div class="image"><img resize-home class="current_image" src="{{pow.url}}?w={{windowWidth}}"" alt="{{pow.caption}}"></div><div class="teacher_info"><h6><a href="#/photo_of_week/" ng-bind-html="pow.titleSnippet"></a></h6><span class="caption">Photo By: {{pow.credit}}<br><a ng-href="{{pow.parent}}" target="_blank">{{pow.post_title}}</a></div></li></ul></div></div><div><a class="navPrev3" ng-click="prev(\'pow\');">««</a><a ng-click="next(\'pow\')" class="navNext3" >»»</a></div><script>myScroll_pow  = new iScroll("wrapper_pow", {hScrollbar:false});</script>';
