...
TAS_SITE.directive('ytVideos', function() {
	...
	var Current = '<div id="wrapper"><div id="scroller_current" class="scroller" ><ul><li tabindex="109" ng-repeat="teacher in data"><div class="image"><a tabindex="109" href="#/{{teacher.year}}/{{teacher.firstname}}*{{teacher.lastname}}"><span class="loading"> <img src="/images/NOAA-Logo.gif" class="no-border"/></span><img tabindex="109" resize-current class="current_image no-border" ng-src="{{teacher.finalImage}}?w={{windowWidth}}" alt="{{teacher.firstname}} {{teacher.lastname_forDOM}}" imageonload/></a> </div><div tabindex="109" class="teacher_info"><h6 tabindex="109"><a tabindex="109" href="#/{{teacher.year}}/{{teacher.firstname}}*{{teacher.lastname}}">NOAA Teacher at Sea {{teacher.firstname}} {{teacher.lastname_forDOM}} of {{teacher.city}}, {{teacher.state}} {{teacher.verb}} aboard {{teacher.shiptype}} <em>{{teacher.ship}}</em>.</a></h6></div></li></ul></div></div><div><a class="navPrev3" ng-click="prev(\'current\');">««</a><a ng-click="next(\'current\')" class="navNext3" >»»</a></div><script>myScroll  = new iScroll("wrapper", {hScrollbar:false});</script>';
	var Alumni = '<div id="wrapper_alumni"><div id="scroller_alumni" class="scroller" style="transition: transform 0ms; -webkit-transition: transform 0ms; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) translateZ(0px);"><ul><li tabindex="112" ng-repeat = "spot in data"><div class="image"><a tabindex="112" href="#{{spot.hash}}"><span class="loading"> <img src="/images/NOAA-Logo_200.gif" class="no-border"/></span><img imageonload tabindex="112" resize-home class="current_image no-border" ng-src="{{spot.finalImage}}?w={{windowWidth}}"" alt="{{spot.caption}}"></a></div><div class="teacher_info"><h6><a tabindex="112" href="#{{spot.hash}}">{{spot.firstname}} {{spot.lastname}}</a></h6></div></li></ul></div></div><div><a class="navPrev3" ng-click="prev(\'alumni\');">««</a><a ng-click="next(\'alumni\')" class="navNext3" >»»</a></div><script>myScroll_spotlights  = new iScroll("wrapper_alumni", {hScrollbar:false});</script>';
	var Pow = '<div id="wrapper_pow"><div id="scroller_pow" class="scroller" style="transition: transform 0ms; -webkit-transition: transform 0ms; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) translateZ(0px);"><ul ><li tabindex="115" ng-repeat = "pow in data"><div class="image"><a href="#/pow/{{pow.linker}}"><span class="loading"> <img class="no-border" src="/images/NOAA-Logo_200.gif"/></span><img imageonload tabindex="115" resize-home class="current_image no-border" ng-src="{{pow.finalImage}}?w={{windowWidth}}"" alt="{{pow.caption}}"></a></div><div tabindex="115" class="teacher_info"><h6 tabindex="115"><a tabindex="115"href="#/photo_of_week/" ng-bind-html="pow.titleSnippet"></a></h6><span class="caption" tabindex="115" >Photo By: {{pow.credit}}<br><a ng-href="{{pow.parent}}" target="_blank"  tabindex="115" >{{pow.post_title}}</a></div></li></ul></div></div><div><a class="navPrev3" ng-click="prev(\'pow\');">««</a><a ng-click="next(\'pow\')" class="navNext3" >»»</a></div><script>myScroll_pow  = new iScroll("wrapper_pow", {hScrollbar:false});</script>';
	...
	return function(scope, element) {
		...
		scope.$watch(scope.getWindowDimensions, function(newValue, oldValue) {
			...
			} else if (window.innerWidth < 960 && window.innerWidth >= 790) {
